...
$("#play_btn").on("click", (e) => {
  ...
  $("#gameStatusBar").show();
  $("#play_btn").attr("disabled", "disabled").find("span").text("इंतज़ार");
